...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Estudiante',
            fields=[
                ('matricula', models.AutoField(editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('justificacion', models.TextField(blank=True, default='Se realizó el cambio de estrado de estudiante debido a su situación socioeconomica.', null=True)),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'tutores',
                'indexes': [models.Index(fields=['correo'], name='idx_tutor_correo'), models.Index(fields=['telefono'], name='idx_tutor_telefono'), models.Index(fields=['ultima_actualizacion'], name='idx_tutor_ultima_actualizacion')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['estudiante'], name='idx_evalsocio_estudiante'), models.Index(fields=['fecha_evaluacion'], name='idx_evalsocio_fecha'), models.Index(fields=['aprobado'], name='idx_evalsocio_aprobado')],
            },
        ),
        migrations.AddIndex(
            model_name='grupo',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['estudiante'], name='idx_his_es'),
        ),
        migrations.AddIndex(
            model_name='historialestratoestudiante',
